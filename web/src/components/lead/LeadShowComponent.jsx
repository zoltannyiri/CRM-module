...
import { formatLeadDate, formatLeadDateTime, memberName, leadStatusClasses, leadStatusLabels, leadSourceLabels } from "./leadDisplay.js";
import { canConvertLead } from "./leadConversion.js";
...
function LeadShow({ leadId, onEdit, onConvert }) {
  ...
  if (!lead) return null;
  const canConvert = canConvertLead({ lead, hasModule, hasPermission });
