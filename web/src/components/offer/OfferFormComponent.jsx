...
function OfferForm({ mode = "create", offer, defaultPartnerId, defaultProjectId, onClose, onSaved }) {
  ...
  return <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-labelledby="offer-form-title">
    <button type="button" aria-label="Ajánlat űrlap bezárása" onClick={onClose} className="starting:opacity-0 absolute inset-0 cursor-pointer border-0 bg-[#17272b]/35 backdrop-blur-[1px] transition-opacity duration-200" />
