  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/follow-up/:id" element={<Workspace><ModuleRoute module="FOLLOW_UPS"><PermissionRoute permission="FOLLOW_UPS_VIEW"><ModuleRoute module="LEADS"><PermissionRoute permission="LEADS_VIEW"><FollowUpPage /></PermissionRoute></ModuleRoute></PermissionRoute></ModuleRoute></Workspace>} />
