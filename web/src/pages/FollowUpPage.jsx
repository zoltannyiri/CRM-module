...
export default function FollowUpPage() {
  ...
  if (id) return <div className="min-h-dvh bg-[#f3f5f6] text-[#253238]">
    ...
    <main className="px-5 py-6 lg:px-7"><TabView key={id} className={tabsClass} renderActiveOnly>
      <TabPanel header="Alapadatok"><FollowUpShowComponent key={id} followUpId={id} reloadKey={reloadKey} onEdit={(followUp) => setForm({ followUp, mode: "edit" })} /></TabPanel>
      {hasPermission("ACTIVITY_VIEW") && <TabPanel header="Tevékenységek"><FollowUpActivityComponent followUpId={id} reloadKey={reloadKey} /></TabPanel>}
    </TabView></main>
