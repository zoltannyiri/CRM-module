  ...
  return (
    <div className="min-h-dvh bg-[#f3f5f6] text-[#253238]">
      ...
      <div className="px-5 py-5">
        <ProjectListComponent query={query} statusFilter={statusFilter} partnerFilter={partnerFilter} sortDirection={sortDirection} reloadKey={reloadKey} onEdit={openEdit} />
      </div>
