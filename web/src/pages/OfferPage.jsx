...
const tabsClass = "[&_.p-tabview-nav-container]:border-b [&_.p-tabview-nav-container]:border-[#dfe5e3] [&_.p-tabview-nav]:m-0 [&_.p-tabview-nav]:flex [&_.p-tabview-nav]:list-none [&_.p-tabview-nav]:gap-6 [&_.p-tabview-nav]:p-0 [&_.p-tabview-header]:list-none [&_.p-tabview-nav-link]:inline-flex [&_.p-tabview-nav-link]:border-b-2 [&_.p-tabview-nav-link]:border-transparent [&_.p-tabview-nav-link]:pb-3 [&_.p-highlight_.p-tabview-nav-link]:border-[#78ad7d] [&_.p-tabview-panels]:p-0 [&_.p-tabview-panels]:pt-6";
...
export default function OfferPage() {
  ...
  if (id) {
    return <div className="min-h-dvh bg-[#f3f5f6] text-[#253238]">
      <Topbar />
      <div className="flex items-center gap-3 border-b border-[#e3e8e6] bg-white px-5 py-3 lg:px-7"><button type="button" onClick={() => navigate("/offer")} className="inline-flex h-9 items-center gap-2 rounded-md border border-[#d6dddc] bg-white px-3 text-xs font-medium"><i className="pi pi-arrow-left text-xs" aria-hidden="true" />Vissza az ajánlatokhoz</button><span className="h-4 w-px bg-[#dbe1df]" /><h1 className="text-sm font-semibold">Ajánlat adatlap</h1></div>
