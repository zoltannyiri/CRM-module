...
router.post("/:id/convert", requireModule("PARTNERS"), requirePermission("LEADS_VIEW"), requirePermission("LEADS_CONVERT"), requirePermission("PARTNERS_CREATE"), leadController.convertLead);
